...
namespace AgeGrading
{
    class RaceInfo
    {
        ...
        {
            BuildRaceInfo();
            if (mRaces == null || mRaces.Count <= 0) return DateTime.Parse("1/1/2024");
            ...
            return DateTime.Parse("01/01/2024");
        }
        ...
        public static string UNKNOWNDATE = "01/01/2024";
        ...
        public static void BuildRaceInfo()
        {
            ...
            raceInfo = new RaceInfo(kDefaultRaceName, 5.0000000, 0.0, DateTime.Parse("01/01/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("War Party 10K", 10.0000000, 0.0, DateTime.Parse("02/19/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Bat 5 Miler", 8.0467200, 5.0, DateTime.Parse("09/30/24")); mRaces.Add(raceInfo);
            //raceInfo = new RaceInfo("Restore Your Sole 5K", 5.0000000, 0.0, DateTime.Parse("5/1/21")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Virginia Creeper 10 Miler", 16.0934400, 10.0, DateTime.Parse("05/28/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Restore Your Sole 5K", 5.0000000, 0.0, DateTime.Parse("05/11/24")); mRaces.Add(raceInfo);
            ...
            raceInfo = new RaceInfo("Laurel Run Ascent", 17.7027840, 11.0, DateTime.Parse("04/13/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Run the Tunnel", 6.1155072, 3.8, DateTime.Parse("04/30/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Duck Island Spring Mile", 1.6093440, 1.0, DateTime.Parse("5/10/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Amis Mill 10K", 10.0000000, 0.0, DateTime.Parse("06/25/24")); mRaces.Add(raceInfo);
            ...
            raceInfo = new RaceInfo("Phipps Bend River Run", 0.0, 10.0, DateTime.Parse("03/23/24")); mRaces.Add(raceInfo);
            //raceInfo = new RaceInfo("Mountain States Rehab 5K", 5.0000000, 0.0, DateTime.Parse("06/17/21")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Varmint Half Marathon", 21.0824064, 13.1, DateTime.Parse("06/11/24")); mRaces.Add(raceInfo);
            //raceInfo = new RaceInfo("Crooked River Half Marathon", 21.0824064, 13.1, DateTime.Parse("10/15/21")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Rhododendron 10K", 10.0000000, 0.0, DateTime.Parse("06/18/24")); mRaces.Add(raceInfo);
            //raceInfo = new RaceInfo("Firecracker 4 miler", 6.4373760, 4.0, DateTime.Parse(UNKNOWNDATE)); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Red, White & Boom 4 Miler", 6.4373760, 4.0, DateTime.Parse("7/2/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Crazy 8s 8K", 8.0000000, 0.0, DateTime.Parse("07/20/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Wolf Run 7 Miler", 11.2654080, 7.0, DateTime.Parse("7/18/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Railroad Days 5K", 5.0000000, 0.0, DateTime.Parse("8/07/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Duck Island Summer Mile", 1.6093440, 1.0, DateTime.Parse("8/16/24")); mRaces.Add(raceInfo);
            ...
            raceInfo = new RaceInfo("Baileyton Celebration 5K", 5.0000000, 0.0, DateTime.Parse("9/11/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Bays Mountain Trail Race", 24.1401600, 15.0, DateTime.Parse("9/14/24")); mRaces.Add(raceInfo);
            //raceInfo = new RaceInfo("Rhythm & Roots 5K", 5.0000000, 0.0, DateTime.Parse("9/11/21")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Apple Festival 4 Miler", 6.4373760, 4.0, DateTime.Parse("10/02/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Duck Island Fall Mile", 1.6093440, 1.0, DateTime.Parse("10/11/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("NCH Heart-One Cardiac Rehab 5K Run", 5.0000000, 0.0, DateTime.Parse("10/08/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Run Fur Their Lives 5K", 5.0000000, 0.0, DateTime.Parse("10/02/24")); mRaces.Add(raceInfo);
            //raceInfo = new RaceInfo("Run Fur Their Lives 10K", 10.0000000, 0.0, DateTime.Parse("10/06/21")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Surgoinsville 10 Miler", 16.0934400, 10.0, DateTime.Parse("02/24/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Haunted Half Marathon", 21.0824064, 13.1, DateTime.Parse("10/30/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Race for the Birthplace 6 Miler", 0.0000000, 6.0, DateTime.Parse("11/04/24")); mRaces.Add(raceInfo);
            //raceInfo = new RaceInfo("Tri-Cities Race for the Cure 5K", 5.0000000, 0.0, DateTime.Parse("10/13/21")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Surgoinsville Half Marathon", 21.0824064, 13.1, DateTime.Parse("10/14/24")); mRaces.Add(raceInfo);
            //raceInfo = new RaceInfo("Santa Special Open Mile", 1.6093440, 1.0, DateTime.Parse("11/19/21")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Johnson City Turkey Trot 5K (Up & At 'Em)", 5.0000000, 0.0, DateTime.Parse("11/25/24")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Pioneer 5 Miler", 8.0467200, 5.0, DateTime.Parse("12/16/24")); mRaces.Add(raceInfo);
