...
namespace AgeGrading
{
    class RaceInfo
    {
        ...
        public static void BuildRaceInfo()
        {
            ...
            raceInfo = new RaceInfo("Mendota 5K River Run", 5.0000000, 0.0, DateTime.Parse("03/11/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("5K Run for St Anne School", 5.0000000, 0.0, DateTime.Parse("05/13/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Chasing Snakes 10K", 10.0000000, 0.0, DateTime.Parse("03/18/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Laurel Run Ascent", 17.7027840, 11.0, DateTime.Parse("4/15/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Run the Tunnel", 6.1155072, 3.8, DateTime.Parse("4/29/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Amis Mill 10K", 10.0000000, 0.0, DateTime.Parse("06/3/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Creeper 10 Miler", 16.0934400, 10.0, DateTime.Parse("04/22/17")); mRaces.Add(raceInfo);
            ...
            raceInfo = new RaceInfo("The River Mile", 1.6093440, 1.0, DateTime.Parse("6/6/17")); mRaces.Add(raceInfo);
            //raceInfo = new RaceInfo("Phipps Bend 5K", 5.0000000, 0.0, DateTime.Parse(UNKNOWNDATE)); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Mountain States Rehab 5K", 5.0000000, 0.0, DateTime.Parse("06/17/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Varmint Half Marathon", 21.0824064, 13.1, DateTime.Parse("6/10/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Crooked River Half Marathon", 21.0824064, 13.1, DateTime.Parse("10/15/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Rhododendron 10K", 10.0000000, 0.0, DateTime.Parse("6/17/17")); mRaces.Add(raceInfo);
            ...
            raceInfo = new RaceInfo("Crazy 8s 8K", 8.0000000, 0.0, DateTime.Parse("7/15/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Wolf Run 7 Miler", 11.2654080, 7.0, DateTime.Parse("7/18/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Railroad Days 5K", 5.0000000, 0.0, DateTime.Parse("8/5/17")); mRaces.Add(raceInfo);
            ...
            raceInfo = new RaceInfo("Greene County YMCA 5K", 5.0000000, 0.0, DateTime.Parse("8/19/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Eastman 10K", 10.0000000, 0.0, DateTime.Parse("9/9/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Baileyton Celebration 5K", 5.0000000, 0.0, DateTime.Parse("9/9/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Bays Mountain Trail Race", 24.1401600, 15.0, DateTime.Parse("9/23/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Rhythm & Roots 5K", 5.0000000, 0.0, DateTime.Parse("9/16/17")); mRaces.Add(raceInfo);
            ...
            raceInfo = new RaceInfo("Johnson City Turkey Trot 5K (Up & At 'Em)", 5.0000000, 0.0, DateTime.Parse("11/23/17")); mRaces.Add(raceInfo);
            raceInfo = new RaceInfo("Pioneer 5 Miler", 8.0467200, 5.0, DateTime.Parse("12/16/17")); mRaces.Add(raceInfo);
